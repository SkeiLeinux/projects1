...
class Game():
    def __init__(self):
        ...
        self.custom = pygame.Color(0, 100, 0)
        self.field = pygame.Color(140, 170, 26)
...
class Snake():
    def __init__(self, snake_color):
        """позиция головы змеи и его тела"""
    ...
    def snake_body_mechanism(
        ...
        if (self.snake_head_pos[0] == food_pos[0] and
            ...
            """задаем новое положение еды случайным
...
food = Food(game.black, game.screen_width, game.screen_height)
...
while True:
    ...
    snake.draw_snake(game.play_surface, game.field)
